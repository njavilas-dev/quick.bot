...
console.log(`\x1b[36mRunning workflow: ${workflowName}\x1b[0m`)

const actPath = which.sync('act');

const actProcess = spawn(actPath, [//NOSONAR
  '-W',
...
actProcess.on('close', (code) => {
  if (code === 0) {
    console.log(`\x1b[32mWorkflow completed successfully\x1b[0m`)
  } else {
