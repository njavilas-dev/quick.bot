...
export const CustomDomainConfigModal = ({ workspaceId, isOpen, onClose, domain }: Props) => {
  ...
  const txtVerification =
    (status === 'Pending Verification' && domainJson.verification?.find((x) => x.type === 'TXT')) ||
    null
          ...
          {txtVerification ? (
            <Stack spacing="4">
              ...
              <Alert status="warning">
                <AlertIcon />
                <Text>
                  If you are using this domain for another site, setting this TXT record will
                  transfer domain ownership away from that site and break it. Please exercise
