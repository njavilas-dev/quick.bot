...
type UserAuthChangedPasswordProps = {
  userName: string
  changedAt: string
}

export const UserAuthChangedPasswordEmail = ({
  userName,
  changedAt,
}: UserAuthChangedPasswordProps) => (
  <Mjml>
    <Head />
    <MjmlBody width={600}>
      ...
      <MjmlSection padding="0 24px" cssClass="smooth">
        <MjmlColumn>
          ...
          <Text>
            Your password has been successfully changed on QuickBot.
          </Text>
          <Text>
...
export const sendUserAuthChangedPasswordEmail = ({
  to,
  ...props
}: Pick<SendMailOptions, 'to'> & ComponentProps<typeof UserAuthChangedPasswordEmail>) =>
  sendEmail({
    to,
    subject: "QuickBot - 🔒 Password Successfully Updated",
    html: render(<UserAuthChangedPasswordEmail {...props} />).html,
  })
