...
type WorkspaceMemberInvitationEmailProps = {
...
export const WorkspaceMemberInvitationEmail = ({
  ...
  hostEmail,
  guestEmail,
}: WorkspaceMemberInvitationEmailProps) => (
  <Mjml>
    <Head />
    <MjmlBody width={600}>
      ...
      <MjmlSection padding="0 24px" cssClass="smooth">
        <MjmlColumn>
          ...
          <Text>From now on you will see this workspace in your dashboard 👍</Text>
          <Text>
          ...
          <Text fontSize="12px" color="#888888">
            If the button doesn’t work, you can access the workspace using this link:{' '}
...
export const sendWorkspaceMemberInvitationEmail = ({
  to,
  ...props
}: Pick<SendMailOptions, 'to'> & ComponentProps<typeof WorkspaceMemberInvitationEmail>) =>
  sendEmail({
    to,
    subject: "QuickBot - You're invited to become a workspace member",
    html: render(<WorkspaceMemberInvitationEmail {...props} />).html,
  })
