import { ContinueChatResponse, ChatSession, SetVariableHistoryItem } from '@quickbot.io/schemas'
import { upsertResult } from './queries/upsertResult'
import { updateSession } from './queries/updateSession'
import { createSession } from './queries/createSession'
import { deleteSession } from './queries/deleteSession'
import { Prisma, BotResultVisitedEdge } from '@quickbot.io/prisma'
...
export const saveStateToDatabase = async ({
  ...
  queries.push(
    upsertResult({
      ...
      isCompleted: Boolean(!input && !containsSetVariableClientSideAction && answers.length > 0),
