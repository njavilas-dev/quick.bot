...
import { botLinkBlockSchema } from './botLink'
...
const logicBlockV5Schema = z.discriminatedUnion('type', [...logicBlockSchemas.v5])

const logicBlockV6Schema = z.discriminatedUnion('type', [...logicBlockSchemas.v6])
