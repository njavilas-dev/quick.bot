...
export const choiceInputOptionsSchema = optionBaseSchema.merge(
  z.object({
    ...
    whatsappFlowHeader: z.string().optional(),
    whatsappFlowBody: z.string().optional(),
    whatsappFlowButtonText: z.string().optional(),
    whatsappFlowQuestionLabel: z.string().optional(),
  }),
)
...
export const buttonItemSchema = z.union([buttonItemSchemas.v5, buttonItemSchemas.v6])
...
export const buttonsInputSchema = z.union([buttonsInputSchemas.v5, buttonsInputSchemas.v6])
