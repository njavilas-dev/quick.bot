...
import { listVariableValue, variableWithValueSchema } from './bot/variable'
import {
  BotResult as ResultPrisma,
  BotLog as LogPrisma,
  BotResultVariableHistory as SetVariableHistoryItemPrisma,
  BotResultVisitedEdge,
...
export const visitedEdgeSchema = z.object({
  ...
  resultId: z.string(),
  index: z.number(),
}) satisfies z.ZodType<BotResultVisitedEdge>
...
export type ResultWithAnswersInput = z.infer<typeof resultWithAnswersInputSchema>
export type Log = z.infer<typeof logSchema>

export type ResultValuesInput = Pick<ResultWithAnswersInput, 'answers' | 'createdAt' | 'variables'>

export type ResultValues = Pick<ResultWithAnswers, 'answers' | 'createdAt' | 'variables'>
