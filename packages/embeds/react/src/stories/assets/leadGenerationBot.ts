import { StartBot } from '@quickbot.io/schemas'
...
import { BackgroundType } from '@quickbot.io/schemas/features/bot/theme/constants'

export const leadGenerationBot: StartBot = {
  version: '3',
        ...
        },
        {
          ...
          content: {
            ...
            richText: [
              {
                type: 'p',
                children: [{ text: "What's the best email we can reach you at?" }],
              },
            ],
      ...
      blocks: [
        {
          ...
          content: {
            ...
            richText: [{ type: 'p', children: [{ text: "What's your name?" }] }],
      ...
      blocks: [
        {
          ...
          content: {
            ...
            richText: [
              {
                type: 'p',
                children: [{ text: 'Can you tell me a bit more about your needs?' }],
              },
            ],
      ...
      blocks: [
        {
          ...
          content: {
            ...
            richText: [{ type: 'p', children: [{ text: 'Hi {{={{Name}}[0]=}}!' }] }],
            plainText: 'Hi {{={{Name}}[0]=}}!',
          },
  ...
  theme: {
    chat: {
      ...
      buttons: { color: '#FFFFFF', backgroundColor: '#01a952' },
      hostAvatar: {
        url: 'https://avatars.githubusercontent.com/u/6652831?v=4',
        isEnabled: true,
      },
