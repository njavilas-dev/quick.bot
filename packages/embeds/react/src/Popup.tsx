...
import type { PopupProps } from '@urbiport/js'
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'quickbot-popup': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
        class?: string
      }
    }
  }
...
export const Popup = (props: Props) => {
  ...
  const attachPopupToContainer = useCallback((props: Props) => {
    const popupElement = document.createElement('quickbot-popup') as PopupElement
