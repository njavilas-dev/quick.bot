...
```bash
npm install @urbiport/js @urbiport/react
```

## Standard

```tsx
import { Standard } from '@urbiport/react'
...
```js
import { open } from '@urbiport/react'

open()
```

```js
import { close } from '@urbiport/react'

close()
```

```js
import { toggle } from '@urbiport/react'
...
```js
import { showPreviewMessage } from '@urbiport/react'

QuickBot.showPreviewMessage()
```

```js
import { hidePreviewMessage } from '@urbiport/react'
