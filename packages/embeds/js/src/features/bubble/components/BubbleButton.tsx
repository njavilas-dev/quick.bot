...
import { isNotDefined, isSvgSrc } from '@quickbot.io/lib'
...
const defaultButtonColor = '#01a952'
  ...
  >
    <Show when={isNotDefined(props.customIconSrc)} keyed>
      <svg
        ...
        viewBox="0 0 24 24"
        style={{
          stroke: props.iconColor ?? defaultLightIconColor,
        }}
        class={clsx(
    ...
    <Show when={isNotDefined(props.customCloseIconSrc)}>
      <svg
        ...
        style={{
          fill:
            props.iconColor ?? defaultLightIconColor,
        }}
        class={clsx(
