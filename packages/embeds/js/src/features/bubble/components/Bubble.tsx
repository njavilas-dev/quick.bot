...
export const Bubble = (props: BubbleProps) => {
  ...
  return (
    <Show when={isMounted()}>
      <EnvironmentProvider value={document.querySelector('bot-bubble')?.shadowRoot as Node}>
        <style>{styles}</style>
        ...
        <div
          ...
          class={
            ...
            (props.theme?.placement === 'left' ? ' left-5' : ' sm:right-5 right-0')
          }
        >
...
): `${number}px` => (size === 'medium' ? '48px' : size === 'large' ? '64px' : size ? size : '48px')
