import { Switch, Match, Show, createSignal, createEffect, onCleanup } from 'solid-js'
...
export const SelectedFile = (props: {
  ...
  return (
    <div class="relative group flex-shrink-0">
      ...
      <Show when={isDefined(props.uploadProgressPercent) && props.uploadProgressPercent !== 100}>
...
const UploadOverlay = (props: { progressPercent?: number }) => {
  ...
  return (
    <div class="absolute w-full h-full inset-0 bg-black/20 rounded-md">
      <Progress.Root value={progressPercent()} class="flex items-center justify-center">
        <Progress.Circle>
