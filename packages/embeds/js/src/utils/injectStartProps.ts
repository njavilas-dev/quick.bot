...
import { injectCustomHeadCode, isDefined, isNotEmpty } from '@quickbot.io/lib/utils'
import { StartPropsToInject } from '@quickbot.io/schemas'

export const injectStartProps = async (startPropsToInject: StartPropsToInject) => {
