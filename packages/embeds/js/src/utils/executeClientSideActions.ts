...
import { streamChat } from '@/features/streaming/streamChat'
import { executeRedirect } from '@/features/blocks/logic/redirect'
import { executeScript, executeCode } from '@/features/blocks/logic/script/executeScript'
...
> => {
  ...
  if ('wait' in clientSideAction) {
    ...
    return clientSideAction.expectsDedicatedReply ? { replyToSend: undefined } : undefined
  }
